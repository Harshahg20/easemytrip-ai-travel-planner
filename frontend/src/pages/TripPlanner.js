...
import PackingList from "../components/trip-planner/PackingList";
          ...
          <div>
            ...
            <div className="sticky top-0 z-30 bg-white/90 backdrop-blur border-b border-slate-200">
              ...
              >
                <TabsList className="px-2 gap-2">
                  ...
                  <TabsTrigger value="packing" className="px-3">
                    Packing
                  </TabsTrigger>
                </TabsList>
              </Tabs>
            </div>
            {/* Day selector - Only show when itinerary tab is active */}
            {activeTab === "itinerary" && (
              <div className="py-4">
                <DaySelector
            ...
            >
              ...
              <TabsContent value="packing" className="space-y-6">
                <PackingList trip={trip} selectedDay={selectedDay} />
              </TabsContent>
            </Tabs>
